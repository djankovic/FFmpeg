...
#define FF_RTP_FLAG_START_MARKER 32
...
#define FF_RTP_FLAG_OPTS(ctx, fieldname) \
    ...
    { "start_marker", "Set the marker bit on the first RTP packet", 0, AV_OPT_TYPE_CONST, { .i64 = FF_RTP_FLAG_START_MARKER }, INT_MIN, INT_MAX, AV_OPT_FLAG_ENCODING_PARAM, "rtpflags" } \
